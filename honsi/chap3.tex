...
決定的であるという．
また，$T$の任意の異なる遷移規則$[p,\langle s,t\rangle,q]$，
$[p',\langle s',t'\rangle,q'] \in \delta$ に対して
...
\\
 ...
 る．2本目のテープは各計算ステップで$T$のどの3項組で遷移されたのかを記録する．3本目のテープは1本目のテープの記述をコピーし，結果を記録する．
 ...
 異なる任意の3項組
 $[p,\langle
 [s_{1},s_{2},s_{3}],[t_{1},t_{2},t_{3}]\rangle,q]$,$[p',\langle
