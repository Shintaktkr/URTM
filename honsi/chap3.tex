...
り$T_2$は可逆チューリング機械である．\par
 また，この遷移規則による様相を3.1.2節の様相の計算ステップの記法を用いて
 表わす.予め，テープに格納されている2進数を「101」とする，
\\
\\ 
\[
 \begin{array}{llcr}\small
...
\\
 ...
 リング機械に作り変えること(可逆シミュレーション)が出来るということを実際に
 例を用いて説明する．
...
$T_1$は次の理由により非可逆なチューリング機械である．$q_3$が3番目の項として現れている3項組は 
           ...
           読んでいるます目が1ならば，(i),(i\hspace{-,1em}i)または
...
\\
 ...
 械を3本のテープを持つチューリング機械を用いて可逆シミュレーションを行う．3テープ可逆チューリング機械　
 $T''$を3.2.1小節の定義より
...
$\}$\\
 ...
 テープに記録する．記録後に不必要情報を消去するため状態を$p_f$に遷移する．
