...
\end{center}
である．まずマクロ\texttt{MOVEL(T)}が実行される．
%る．そのなかで
...
れる変数は３パターンそれぞれ
\begin{center}
\texttt{(L}$ \ \overline{s}$ \ \texttt{R)} \texttt{=>}
 \texttt{(L} \ $\overline{b} \ \overline{s}$ \texttt{.R)}\\
\texttt{(L.}$\overline{s'} \ \overline{s}$ \ \texttt{R)} \texttt{=>}
 \texttt{(L} \ $\overline{s'} \ \overline{s}$ \texttt{.R)}\\
\texttt{(L.}$\overline{s'} \ \overline{b}$ \ \texttt{R)} \texttt{=>}
 \texttt{(L} \ $\overline{s'} \ $\texttt{R)}\\
\end{center}
...
\begin{center}
\texttt{[}$\overline{q}$\texttt{,(L}\ $\overline{s}$ \
 \texttt{R)]} \texttt{=>} \texttt{[}$\overline{q'}$\texttt{,(L} \
 $\overline{b} \ \overline{s}$ \texttt{.R)]}\\
\texttt{[}$\overline{q}$\texttt{,(L.}$\overline{s'} \ \overline{s}$ \ \texttt{R)]} \texttt{=>} \texttt{[}$\overline{q'}$\texttt{,(L} \ $\overline{s'} \ \overline{s}$ \texttt{.R)]}\\
\texttt{[}$\overline{q}$\texttt{,(L.}$\overline{s} \ \overline{b}$ \ \texttt{R)]} \texttt{=>} \texttt{[}$\overline{q'}$\texttt{,(L} \ $\overline{s} \ $ \texttt{R)]}\\
\end{center}
の様に書き換えられ，それぞれ
\begin{center}
...
\begin{center}
 ...
 \textasciicircum=}$\overline{q}$\texttt{; Q \textasciicircum=}$\overline{q'}$\}
\end{center}
である．まずマクロ\texttt{MOVER(T)}が実行され，\texttt{T}に束縛さ
れる値はそれぞれ
\begin{center}
\texttt{(L} \ $\overline{s}$ \ \texttt{R)} \texttt{=>}
 \texttt{(L.}$\overline{s} \ \overline{b}$ \ \texttt{R)}\\
\texttt{(L} \ $\overline{s}$ \ $\overline{s'}$\texttt{.R)} \texttt{=>}
 \texttt{(L.}$\overline{s} \ \overline{s'}$ \ \texttt{R)}\\
\texttt{(L} \ $\overline{b}$ \ $\overline{s}$\texttt{.R)} \texttt{=>}
 \texttt{(L}$\ \overline{s}$ \ \texttt{R)}\\
\end{center}
となる．次に１回目の可逆代入を行い\texttt{Q}に束縛される値は\texttt{nil}
となる．そして，２回目の可逆を行うことで\texttt{Q}に束縛される値は
$\overline{q'}$となる．そのため\texttt{[Q.T]}が束縛する値はそれぞれ
\begin{center}
\texttt{[}$\overline{q}$\texttt{,(L} \ $\overline{s}$ \ \texttt{R)]} \texttt{=>} \texttt{[}$\overline{q'}$\texttt{,(L.}$\overline{s} \ \overline{b}$ \ \texttt{R)]}\\
\texttt{[}$\overline{q}$\texttt{,(L} \ $\overline{s}$ \
 $\overline{s'}$\texttt{.R)]} \texttt{=>}
 \texttt{[}$\overline{q'}$\texttt{,(L.}$\overline{s} \ \overline{s'}$ \
 \texttt{R)]}\\
\texttt{[}$\overline{q}$\texttt{,(L} \ $\overline{b}$ \
 $\overline{s}$\texttt{.R)]} \texttt{=>}
 \texttt{[}$\overline{q'}$\texttt{,(L}\ $\overline{s}$ \ \texttt{R)]}\\
\end{center}
の様に書き換えられ，それぞれ
\begin{center}
