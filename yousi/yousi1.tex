...
状態を高々1つもつものである．
$R.Landauer$の研究により，計算機において非可逆計算で消散されるエネルギー量(熱)は，
kTln2(kはボルツマン定数，Tは絶対温度)で与えられることがわかっている\cite{5}．一方，可逆計算ではこのよう
な不可避なエネルギーの発生を減らす1つの解決策として用いられる．すなわち，
...
した値を構成している．可逆的置き換えは右辺の元の値を左辺の変数に束縛する前に，右辺の値を
